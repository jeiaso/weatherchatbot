...
public class Magpie4Refactored{
    ...
    private void setState(int currState){
        //reset all values.  Your state logic may vary
         ...
         switch(currState) {
           case 1:
             introduction=true;
             System.out.println("I am the weather chatbot! What is your name?");
             break;
           ...
           case 4:
            ...
            case 9:
            System.out.println("Nice! The weather the week of halloween was really cold; do you prefer hot or cold weather?");

            case 10:
            System.out.println("Really? Me too! I'm glad it's finally winter. Why?");

            case 11: 
            System.out.println("Really? I prefer the cold! Why do you like hot weather?");

            case 12: 
            System.out.println("Weather rhyme time! When it's cloudy I get pouty!");

            case 13: 
            System.out.println("A lot of people have different thoughts about the rain! Some think it's refreshing while others think it's sad.");
            setState(5);
            */
    ...
    public void getFact(){
        ...
        int question = (int)(r * randRandom);
        if (question == 0){
            System.out.println("Hmmm. That's interesting! Did you know two hurricanes can merge together and become one!?");
        }
        else if (question == 1){
            System.out.println("Rain is one of my favorites! Something I think is cool is that raindrops are shaped more like hamburger buns. As a rain drop falls, it becomes less spherical in shape and becomes more flattened on the bottom like a hamburger bun.");
        }
        else if (question == 2){
            System.out.println("Woah! That's fascinating! By the way, did you know it would take 1.3 million earths to fill up the sun!?");
        }
        else if (question == 3){
            System.out.println("The cold? Interesting! Something I think that's interesing is it takes about an hour for snowflakes to fall to the ground!");
            }
        else{
            System.out.println("Ooo tornadoes? That's very cool! In the whole world, the US gets the most tornadoes but what I find is interesting is that England is number three on that list!");
        }
    }
